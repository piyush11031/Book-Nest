...
export class BookService extends BaseService {
  ...
  static readonly UpdateSharableStatusPath = '/books/sharable/{book-id}';
  ...
  static readonly ApprovedReturnedBookPath = '/books/borrow/return/approve/{book-id}';
  ...
  approvedReturnedBook$Response(params: ApprovedReturnedBook$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return approvedReturnedBook(this.http, this.rootUrl, params, context);
  }
  ...
  approvedReturnedBook(params: ApprovedReturnedBook$Params, context?: HttpContext): Observable<number> {
    return this.approvedReturnedBook$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }

...
public class BookController {
    ...
    //when a user borrows a book, he also needs to return it and owner of book needs to see that book is returned
    @GetMapping("/returned")
    ...
    public ResponseEntity<Integer> approvedReturnedBook(
            @PathVariable("book-id") Integer bookId,
            Authentication connectedUser){
        return ResponseEntity.ok(bookService.approvedReturnedBook(bookId, connectedUser));
    }
